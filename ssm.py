# https://github.com/fsfelix/audio-thumbnailing/blob/11f0ca1faf0a7d191232d0446d908cebce503789/ssm.py#L7
...
class ssm:
    ...
    def visualize(self):
        ...
        librosa.display.specshow(
            self.s, x_axis='frames', y_axis='frames', sr=self.sr, n_xticks=12)
        plt.title('SSM')
        plt.set_cmap('hot_r')
        plt.colorbar()
        plt.show()
    ...
    def path_smooth(self, k=20):
        self.s = scipy.ndimage.filters.median_filter(
            self.s, footprint=np.eye(k))
